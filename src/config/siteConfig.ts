...
const SITE_TIMEZONE = 8; // 时区，东八区为 8，西五区为 -5，以此类推
const SITE_URL =
...
export const siteConfig: SiteConfig = {
	title: "黑利群",
	subtitle: "Vibecoding...",
	siteURL: SITE_URL, // 请通过 SITE_URL 或 VERCEL_URL 提供站点地址
	...
	navbarTitle: {
		...
		// 顶栏标题文本
		text: "黑利群",
		// 顶栏标题图标路径，默认使用 public/assets/home/home.jpg
		icon: "assets/home/home.jpg",
		// 网站Logo图片路径
		logo: "assets/home/default-logo.jpg",
	},
	...
	bilibili: {
		vmid: "353704869", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	banner: {
		...
		homeText: {
			...
			subtitle: ["AI Artist", "Vibecoding...", "Stay hungry, stay foolish"],
			typewriter: {
	...
	toc: {
		...
		useJapaneseBadge: false, // 使用日语假名标记（あいうえお...）代替数字。中文站点建议关闭
	},
